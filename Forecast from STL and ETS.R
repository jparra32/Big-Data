...
# e. Which method gives the best forecasts? Does it pass the residual tests?
  ...
  ##f. Compare the same five methods using time series cross-validation with the tsCV function instead of using a training and test set
